            ...
            <div className='container_grid'>
                <div className="info">
                    ...
                    <div className="emailBlock">
                        <div>Email:</div>
                        <a href="https://mail.google.com/mail/u/0/?tab=rm&ogbl#inbox?compose=new" className="email">demo@gmail.com</a>
                    </div>
                    <div className="phoneNumberBlock">
                        <div>Phone: 01234567891</div>
                    </div>
                    <div className="add">Address: 123, Trần Văn A, Phường 70, quận 80, TP.A</div>
                </div>
